...
<html lang="en">
  ...
  <body>
        ...
        <div class="container-fluid page-body-wrapper">
            <div style="overflow-x:auto;"class="container"align='center'>
                <table>
                ...
                @foreach($order as $orders)
                    <tr align="center" style="background-color:black;">
                        ...
                        <td style="padding: 20px;"><a class="btn btn-success" href="{{url('updatestatus',$orders->id)}}">Deliver</a></td>
                        <td>
                          <a href="{{url('print',$orders->id)}}" Class="btn btn-secondary">Print PDF</a>
                        </td>
                    </tr>
